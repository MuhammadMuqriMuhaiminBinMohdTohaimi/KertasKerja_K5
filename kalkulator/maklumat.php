...
<?php
include('can.php');
$sql="SELECT * from loginpengguna ORDER BY username";
...
<tr>
<td align="center" bgcolor="lightgreen"><strong>Username</strong></td>
<td align="center" bgcolor="lightgreen"><strong>Password</strong></td>

<td align="center" bgcolor="lightgreen"><strong>Padam</strong></td> 
</tr>
...
while($row=mysql_fetch_array($result))
{
	...
	echo"<td>","<a href=\"pros_delete.php?username=".$row['username']."\">Padam </a>";//kod PHP
}
echo"</table>";
echo"<center>";
echo"<br>";
